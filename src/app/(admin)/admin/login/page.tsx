    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-container-lowest px-4">
      <div className="bg-neutral-white max-w-md w-full rounded-2xl p-8 shadow-xl border border-outline-variant">
        <div className="text-center mb-8">
          ...
          <p className="font-body-md text-legal-gray">Sign in with an authorized Google account to access your dashboard</p>
        </div>
        ...
        <form className="flex flex-col gap-5">
          ...
          <Button type="submit" formAction={loginWithGoogle} variant="primary" className="w-full justify-center py-4 flex items-center gap-3">
