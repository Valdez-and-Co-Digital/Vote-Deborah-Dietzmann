        ...
        <div className="max-w-[1200px] mx-auto flex flex-col items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#f09433] via-[#e6683c] to-[#bc1888] hover:scale-110 transition-transform flex items-center justify-center shadow-lg"
